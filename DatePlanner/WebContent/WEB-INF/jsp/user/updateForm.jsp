        ...
        <div class="jumbotron">
            ...
            <form id="joinForm" action="doJoin" method="POST" enctype="multipart/form-data">
                <table class="table table-condensed">
                    ...
                    <tr>
                        <td>비밀번호 : </td>
                        <td><input id="password" name="password" value="${user.password}" type="password" required></td>
                    </tr>
                    <tr>
                        <td>이름 : </td>
                        <td><input name="name" value="${user.name}" required readonly></td>
                    </tr>
                    <tr>
                        <td>닉네임 : </td>
                        <td><input name="nickname" value="${user.nickname}" required readonly></td>
                    </tr>
                    <tr>
                        <td>지역</td>
                        <td>
                    ...
                    <tr>
                        <td colspan="2"><button class="btn btn-info">수정하기</button></td>
                    </tr>
                    </tbody>
                </table>
            </form>
