...
<div class="parallex">
    ...
    <div id="board_info">
        ...
        <span id="region">이 글은 현재 <i class="fas fa-map-marker-alt"></i>${post.regionNo}</span>
    </div>
</div>
...
<div class="container-fluid">
    ...
    <div id="good">
        ...
        <span style="display: block">55,498,451,981</span>
    </div>
    ...
    <div class="jumbotron">
        <div>
            ...
            <div id="comment_write">
                <div id="profile">
                    <img src="img/여친짤.jpg" style="width: 50px; height: 50px; float: left;">
                    <span style="float: left; font-weight: bold; padding-left: 10px; margin-top: 15px">patk</span>
                </div>
                <form action="#">
